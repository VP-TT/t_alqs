    ...
    <section id="services" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Link to="/summarization" className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-6">
              <FileText className="h-10 w-10 text-green-600" />
              <h3 className="text-2xl font-bold text-gray-900 ml-4">Legal Document Summarization</h3>
            </div>
          ...
          {/* Q&A Service */}
          <Link to="/qa" className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
            <div className="flex items-center mb-6">
              <MessageSquareText className="h-10 w-10 text-green-600" />
              <h3 className="text-2xl font-bold text-gray-900 ml-4">Legal Q&A System</h3>
            </div>
            <p className="text-gray-700 mb-6">
